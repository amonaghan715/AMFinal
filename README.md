...
# Usage
The system has 3 actions that it offers the user to take.
1) Search for words related to a query ("the Shakespeare Thesaurus").
2) Search for passages from the text data that match a given theme, with the option to filter results by play title, act and scene number, and speaker.
